\begin{table*}[!ht]
    ...
    \flawtag{F24}{flaw:parameterBuiltFromMethodCalls} & parameterBuiltFromMethodCalls (\opnumber{16}) & Being unable to keep track of a variable as it is passed through a nested number of conditional statements;
    \eg
